...
<head>
	...
	<script src="<?php echo BASE_URL; ?>assets/javascripts/live-player.js"></script>
      <script src="<?php echo BASE_URL; ?>walkthrough/standard.js" type="text/javascript"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>walkthrough/css/tutorial.css" />
