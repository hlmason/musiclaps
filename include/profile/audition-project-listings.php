					<section class="row projects-container projectsContainer" id="auditionProjectsContainer">
						...
						<div class="col-xs-2 col-sm-3 col-md-2">
							<h5 class="last-h5">Audition <span class="glyphicon glyphicon-lock"></span></h5>
						</div>
					</section>