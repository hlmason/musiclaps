...
function musicianSilhouetteRandomizer() {
	...
	images[0] = "<img src='img/landing-pg/rock-band.png' alt='Rock band silhouette'>";  
	  
	images[1] = "<img src='img/landing-pg/jazz-band.png' alt='Jazz band silhouette'>";  
	  
	images[2] = "<img src='img/landing-pg/bluegrass-band.png' alt='Bluegrass band silhouette'>";  
	  
	images[3] = "<img src='img/landing-pg/hip-hop-duo.png' alt='Hip-hop duo silhouette'>";  
	  
	images[4] = "<img src='img/landing-pg/dj-with-crowd.png' alt='Silhouette of DJ with crowd'>";  
