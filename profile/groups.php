			...
			<div class="row col-lg-10 col-lg-offset-1">				
				...
				<div class="row col-xs-12 col-sm-9">
					...
					<section class="row col-xs-12" id="groups-container">
						<h4>Group Name: <span class="normal">$Team XY</span></h4><!-- Hard-coded placeholder -->
						<h4>Project: 
							<?php
						...
						<h4>Member(s): <span class="normal">UsernameA, UsernameB, UsernameC</span></h4><!-- Hard-coded placeholder -->
					</section>
