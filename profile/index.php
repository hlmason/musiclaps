				...
				<div class="row col-xs-12 col-sm-8">
					...
					<div class="row">	
						...
						<div class="col-xs-4 col-sm-4">
							<h2 class="profile-page">$username</h2>
						</div>
						<div class="col-xs-4 col-sm-4">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7" id="about-me">
							...
							<ul>
								...
								<li class="profile-page">Genre: $genre</li><!-- Hard-coded placeholder -->
							</ul>
							<ul>
								<li class="profile-page">Location: $city, $state, $country</li><!-- Hard-coded placeholder -->
								<li class="profile-page">Talent: $talent</li><!-- Hard-coded placeholder -->
							</ul>
						</div>
