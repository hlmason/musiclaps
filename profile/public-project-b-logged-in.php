...
?>
	...
	<div id="wrapper">
		<div class="container">
			...
			<?php
				include(ROOT_PATH . 'include/profile/user-menu-c.php');
			?>
				...
				<!-- Recording Player -->
					...
					<section class="row col-xs-12">
						<div class="public-project-info" id="project-detail-container">
							<h3>Project Details</h3><a href="<?php echo BASE_URL; ?>profile/messages.php"><span class="glyphicon glyphicon-envelope"></span></a>
							<div class="row">
								<div class="col-xs-4">
									<h4>Genre</h4>
									<h4>BPM</h4>
					...
					<section class="row col-xs-12">
						<div class="public-project-info" id="likes-container">
							...
							<a href="<?php echo BASE_URL; ?>profile/public-profile-logged-in.php"><img class="avatar" src="<?php echo BASE_URL; ?>assets/images/profile-pages/female-avatar.png" alt="Placeholder for female Musiclaps user"></a><!-- Hard-coded placeholder -->
						</div>
					</section>
