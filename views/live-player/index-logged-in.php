	...
	<div id="wrapper">
		...
		<section id="recording-instructions">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3" id="allow-flash-chrome-container">
						<p>We recommend using <a href="//www.google.com/intl/en_us/chrome/browser/" target="blank">Google Chrome</a>.&nbsp; In Chrome, you may also need to click "Allow" at the top of the page:</p>
			...
			<div class="container" id="save-container">
				<button class="save" type="button">Save Recording</button><!-- Need to add logic -->
			</div>
