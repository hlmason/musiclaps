<?php
	...
	$page_title = 'Joined Collaborations';
	...
	<div id="wrapper">
		<div class="container">
			...
			<div class="row col-lg-10 col-lg-offset-1">				
				...
				<div class="row col-xs-12 col-sm-8 profile-page joined-public-collaborations-page">
					...
					<section class="row col-xs-12 public-projects-and-collaborations-container">
						...
						<h4 class="my-public-projects-heading">Joined Collaborations <span class="normal">($number)</span></h4><!-- Hard-coded placeholder / Note that this says "My Joined Collaborations" on joined-public-collaborations-logged-in.php -->
