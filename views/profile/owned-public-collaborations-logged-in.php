<?php
	...
	$page_title = 'My Owned Collaborations';
			...
			<div class="row col-lg-10 col-lg-offset-1">				
				...
				<div class="row col-xs-12 col-sm-8 profile-page owned-public-collaborations-page">
					...
					<section class="row col-xs-12 public-projects-and-collaborations-container">
						...
						<h4 class="my-public-projects-heading">My Owned Collaborations <span class="normal">($number)</span></h4><!-- Hard-coded placeholder / Note that this says "Owned Collaborations" on owned-public-collaborations.php -->
